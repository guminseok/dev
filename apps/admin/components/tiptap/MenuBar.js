export const MenuBar = ({ editor }) => {
    ...
    const dClass = "border-solid border-2 border-black p-0.5 m-0.5 space-x-1 bg-gray-400 w-10";
    const aClass = "border-dotted border-2 border-black p-0.5 m-0.5 space-x-1 bg-gray-500 w-10";
